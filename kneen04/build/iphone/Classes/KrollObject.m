...
//@interface kneen04Object : NSObject
//@end

@interface kneen04Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[kneen04Object class]]) {
      for (NSString *key in [[(kneen04Object *)o modules] allKeys]) {
