 ...
 * to send analytic data that can be viewed on the kneen04 Dashboard.
 *
 * For information on getting started with kneen04 Platform Services,
 * see [kneen04 Platform Services for iOS](http://bit.ly/1kqteQS).
 */
