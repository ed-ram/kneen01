...
/**
 The base class for all kneen04 modules
 */
...
/**
 kneen04 Platform calls this method on startup.
 */
- (void)startup;

/**
 kneen04 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 kneen04 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 kneen04 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 kneen04 Platform calls this method on resume.
 @param sender The sender of the event.
 */
