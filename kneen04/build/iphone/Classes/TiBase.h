...
// in simulator we redefine to format for kneen04 Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.kneen04." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.kneen04";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIkneen04NativeItemNone = -1,
  UIkneen04NativeItemSpinner = -2,
  UIkneen04NativeItemProgressBar = -3,

  UIkneen04NativeItemSlider = -4,
  UIkneen04NativeItemSwitch = -5,
  UIkneen04NativeItemMultiButton = -6,
  UIkneen04NativeItemSegmented = -7,

  UIkneen04NativeItemTextView = -8,
  UIkneen04NativeItemTextField = -9,
  UIkneen04NativeItemSearchBar = -10,

  UIkneen04NativeItemPicker = -11,
  UIkneen04NativeItemDatePicker = -12,

  UIkneen04NativeItemInfoLight = -13,
  UIkneen04NativeItemInfoDark = -14,

  UIkneen04NativeItemDisclosure = -15,

  UIkneen04NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all kneen04 instances of
