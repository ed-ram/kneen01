 ...
 * to send analytic data that can be viewed on the kneen03 Dashboard.
 *
 * For information on getting started with kneen03 Platform Services,
 * see [kneen03 Platform Services for iOS](http://bit.ly/1kqteQS).
 */
