...
//@interface kneen03Object : NSObject
//@end

@interface kneen03Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[kneen03Object class]]) {
      for (NSString *key in [[(kneen03Object *)o modules] allKeys]) {
