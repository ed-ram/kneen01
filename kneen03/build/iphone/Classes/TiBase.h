...
// in simulator we redefine to format for kneen03 Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.kneen03." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.kneen03";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIkneen03NativeItemNone = -1,
  UIkneen03NativeItemSpinner = -2,
  UIkneen03NativeItemProgressBar = -3,

  UIkneen03NativeItemSlider = -4,
  UIkneen03NativeItemSwitch = -5,
  UIkneen03NativeItemMultiButton = -6,
  UIkneen03NativeItemSegmented = -7,

  UIkneen03NativeItemTextView = -8,
  UIkneen03NativeItemTextField = -9,
  UIkneen03NativeItemSearchBar = -10,

  UIkneen03NativeItemPicker = -11,
  UIkneen03NativeItemDatePicker = -12,

  UIkneen03NativeItemInfoLight = -13,
  UIkneen03NativeItemInfoDark = -14,

  UIkneen03NativeItemDisclosure = -15,

  UIkneen03NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all kneen03 instances of
