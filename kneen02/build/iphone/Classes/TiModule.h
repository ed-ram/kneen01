...
/**
 The base class for all kneen02 modules
 */
...
/**
 kneen02 Platform calls this method on startup.
 */
- (void)startup;

/**
 kneen02 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 kneen02 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 kneen02 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 kneen02 Platform calls this method on resume.
 @param sender The sender of the event.
 */
