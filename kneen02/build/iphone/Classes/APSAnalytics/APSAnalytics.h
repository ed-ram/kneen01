 ...
 * to send analytic data that can be viewed on the kneen02 Dashboard.
 *
 * For information on getting started with kneen02 Platform Services,
 * see [kneen02 Platform Services for iOS](http://bit.ly/1kqteQS).
 */
