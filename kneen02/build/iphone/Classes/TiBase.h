...
// in simulator we redefine to format for kneen02 Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.kneen02." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.kneen02";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIkneen02NativeItemNone = -1,
  UIkneen02NativeItemSpinner = -2,
  UIkneen02NativeItemProgressBar = -3,

  UIkneen02NativeItemSlider = -4,
  UIkneen02NativeItemSwitch = -5,
  UIkneen02NativeItemMultiButton = -6,
  UIkneen02NativeItemSegmented = -7,

  UIkneen02NativeItemTextView = -8,
  UIkneen02NativeItemTextField = -9,
  UIkneen02NativeItemSearchBar = -10,

  UIkneen02NativeItemPicker = -11,
  UIkneen02NativeItemDatePicker = -12,

  UIkneen02NativeItemInfoLight = -13,
  UIkneen02NativeItemInfoDark = -14,

  UIkneen02NativeItemDisclosure = -15,

  UIkneen02NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all kneen02 instances of
