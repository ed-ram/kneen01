...
//@interface kneen02Object : NSObject
//@end

@interface kneen02Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[kneen02Object class]]) {
      for (NSString *key in [[(kneen02Object *)o modules] allKeys]) {
